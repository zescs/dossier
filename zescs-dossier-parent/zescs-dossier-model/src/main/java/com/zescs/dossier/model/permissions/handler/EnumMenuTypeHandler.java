 ...
 *
 */
public class EnumMenuTypeHandler extends BaseTypeHandler<MenuType> {

	private Class<MenuType> type;

	private final MenuType[] enums;

	public EnumMenuTypeHandler(Class<MenuType> type) {
		if (type == null)
	 ...
	 * @return code对应的枚举类
	 */
	private MenuType locateEnumStatus(int code) {
		for (MenuType entity : enums) {
