...
<body>
	...
	<form method="POST" id="dataForm">
	 <input name="archives.archivesId" id="archivesId" value="${r'${archivesId}'}" class="mini-hidden" />
	 <c:if test="${r'${not empty entryId }'}">
	   <input name="parent.id" id="parent.id" value="${r'${entryId}'}" class="mini-hidden" />
	 </c:if>
	</form>
	...
	<script type="text/javascript">
	  ...
	  function onBeforeload(e){
	  	var data = dataForm.getData(true,false);
	  	e.data=jQuery.extend(e.data,data);
	  }
	 ///////////////////////////////////////////
