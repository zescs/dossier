		...
		<div id="entityDG"
            ...
            allowAlternating="${config.allowAlternating?string('true', 'false')}"
     		...
     		<div property="columns">
				...
				${property_columns}
				<#if existFile>
					<div name="actionHandle" width="120" headerAlign="center" align="center" renderer="onActionHandleRenderer" cellStyle="padding:0;"><fmt:message key="global.message.title.handle"/></div>
     			</#if>
     		</div>
     	</div>
    ...
    <div id="entityDetialForm" style="display:none;height:500px;">
       <div  class="mini-tabs" 
            ...
            <div  title="<fmt:message key="archives.entry.note" />" name="defaultTab" iconCls="icon-cus-view_less_text">
       		...
       		<div  title="<fmt:message key="archives.message.title.tab.volumes" />" name="volumesTab" iconCls="icon-cus-document_letter_marked" refreshOnClick="true" url="<c:url value="/archives/entry/query/volumes/list.action" />"></div>
       </div>
    </div>
	<!-- body-end -->
