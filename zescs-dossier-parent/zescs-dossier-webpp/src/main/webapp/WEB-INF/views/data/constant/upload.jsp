...
<html>
  ...
  <script language="javascript">
	...
	function challs_flash_onCompleteData(data){ //获取服务器反馈信息事件
		data = $.parseJSON(data);
		mini.showMessageBox({
               title: "提示",
  ...
  <body>
   <form id="configForm" method="post" style="text-align: center;padding:10px 3px 3px 3px;">
	     <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,0,0,0" width="442" height="80" id="update" align="middle">
		     ...
		     <embed src="<c:url value="/resources/scripts/CFUpdate/update.swf" />" quality="high" bgcolor="#ffffff" width="442" height="80" name="update" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		 </object>
    </form>
